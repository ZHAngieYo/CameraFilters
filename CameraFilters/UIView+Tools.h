...
@property (nonatomic, readwrite)CGPoint leftTopPosition;
...
- (UITapGestureRecognizer *)addTarget:(id)target tapAction:(SEL)action;
- (UITapGestureRecognizer *)addTarget:(id)target delegate:(id)delegate tapAction:(SEL)action;
- (UITapGestureRecognizer *)addTarget:(id)target delegate:(id)delegate tapAction:(SEL)action numberOfTapsRequired:(NSInteger)numberOfTapsRequired;
