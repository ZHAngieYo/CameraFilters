...
NSString *const kShaderString7 = SHADER_STRING
(
...
@implementation DDFilter7

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kShaderString7 sources:@[[DDImageFilter filterImageNamed:@"fp19.jpg"],[DDImageFilter filterImageNamed:@"fp3"],[DDImageFilter filterImageNamed:@"fp20"]]]))
    {
		return nil;
    }
